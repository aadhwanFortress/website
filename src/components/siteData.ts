...
export const aboutHighlights = [
  ...
  {
    title: 'Our Team',
    text: 'Certified security architects, incident responders, threat hunters, cloud specialists, and compliance advisors work as one delivery team.',
    icon: aboutIcons[1],
  },
  {
    title: 'Why Choose Us?',
...
export const teamMembers = [
  { name: 'Ethan Caldwell', image: teamImages[0], role: 'CISO & Risk Advisory Lead' },
  { name: 'Sophia Lane', image: teamImages[1], role: 'Cloud Security Architect' },
  { name: 'Ryan Mercer', image: teamImages[2], role: 'Threat Intelligence Lead' },
  { name: 'Emma Sinclair', image: teamImages[3], role: 'Incident Response Commander' },
  { name: 'Nathan Steele', image: teamImages[4], role: 'Zero Trust Network Architect' },
]
...
export const pricingPlans = [
  {
    ...
    features: ['External exposure review', 'Policy and control gap check', 'Monthly risk report', 'Business hours advisory'],
  },
  {
    ...
    features: ['24/7 alert triage', 'Endpoint and identity tuning', 'Cloud posture monitoring', 'Priority incident support'],
  },
  {
    ...
    features: ['Dedicated security advisor', 'Incident response retainer', 'Compliance roadmap', 'Executive risk briefings'],
  },
]
...
export const testimonials = [
  ...
  },
  {
    ...
    name: 'Jon Bellamy',
    title: 'Operations Director, Northline Retail',
  },
  {
    quote:
